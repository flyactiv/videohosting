    ...
    <div class="row">
        <div class="col-md-8" style="display: block; width: 600px; margin: 0 auto; background: #eaf1f5; padding: 20px; color:#555; text-align: center;">
            <form action="" method="post" class="form-login" style="display: block; width: 400px; margin: 0 auto;  padding: 20px; text-align: center;">
                <h2><center>Reset Password</h2></center><br>
                <input class="form-control" type="text" name="email" placeholder="E-mail" value="<?php echo $email; ?>"/><br>
                <div class="os"></div>
                <input type="submit" name="submit" class="btn btn-success" style="width: 160px;" value="Reset Password" />
